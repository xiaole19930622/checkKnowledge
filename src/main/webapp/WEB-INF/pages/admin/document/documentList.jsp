    ...
    <div class="col2 col-sm-9">
        <form id="documentSearchFrm" name="search" method="post" action="" onsubmit="return false;">
            <div class="form-group">
                <div class="input-group input-group-lg input-group-md col-md-offset-1">
                    <input name="search_keyword" style="border-radius: inherit;" type="text" class="txt_search form-control" id="search_keyword" value="${searchText}" autocomplete="off" x-webkit-speech="" x-webkit-grammar="builtin:translate" placeholder="标题\简介" data-role="input">
                    <span class="input-group-btn">
                        <input  class="btn btn-green" id="search_button" type="submit" value="搜 索" />
                    </span>
                </div>
            </div>
        </form>
...
<script src="${ctx}/static/js/admin/document/documentList.js"></script>
